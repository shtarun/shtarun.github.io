export const meta = {
	...
	subtitle: 'Founder & CEO @ Twinity Labs · GM @ MKS Enterprises · ex-JLR · IIT Kanpur',
	bio: "I build at the crossroads of mechanical engineering, software, and AI. From redesigning railway suspensions adopted by Indian Railways, to architecting software-defined vehicle platforms at JLR, to shipping SetMind, an AI-powered fitness app, end-to-end, to now building Digital Twin solutions at Twinity Labs while running a heavy-crane business serving industrial India, I'm drawn to problems that live at the intersection of fields.",
